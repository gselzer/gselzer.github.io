...
\resumeSubHeadingList
  \resumeSubheading
      ...
      {Eliceiri Lab (LOCI), Morgridge Institute for Research / University of Wisconsin-Madison}{Madison, WI}
      \resumeSubHeadingList
...
\resumeSubHeadingList
  \resumeItem{\textbf{Professional}: Python, Java, Git/GitHub, IntelliJ, VSCode, Qt, Unix, Jupyter, GitHub Actions, JUnit 4/5, pytest, Maven, Claude Code}
